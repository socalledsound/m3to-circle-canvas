...
export const trigCrowdSound = (idx, audioParameters, dir) => ({
    type : AudioActionTypes.TRIG_CROWD_SOUND,
    payload : {
        idx,
        audioParameters,
        dir
...
export const playAllCrowdSounds = dir => ({
    type : AudioActionTypes.PLAY_ALL_CROWD_SOUNDS,
    payload : {
        dir
    }
})
